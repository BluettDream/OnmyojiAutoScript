...
class ReplaceShikigamiAssets: 
	...
	# 素材 
	I_RS_MATERIAL = RuleImage(roi_front=(34,285,59,56), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_material.png")
	# description 
	I_RS_N = RuleImage(roi_front=(123,295,57,59), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_n.png")
	# description 
	I_RS_R = RuleImage(roi_front=(202,327,64,61), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_r.png")
	# description 
	I_RS_SR = RuleImage(roi_front=(270,383,62,58), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_sr.png")
	# description 
	I_RS_SSR = RuleImage(roi_front=(327,456,63,58), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_ssr.png")
	# description 
	I_RS_SP = RuleImage(roi_front=(361,532,58,60), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_sp.png")
	# description 
	...
	# description 
	I_RS_UR = RuleImage(roi_front=(374,621,56,58), roi_back=(0,265,1072,454), threshold=0.8, method="Template matching", file="./tasks/Component/ReplaceShikigami/rs/rs_rs_ur.png")
	# description 
