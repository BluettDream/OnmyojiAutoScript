...
from tasks.GameUi.page import Page, page_main, page_act_list_climb_act, page_reward, random_click, page_failed, page_shikigami_records
...
page_climb_act.link(button=asa.O_ENTER_AP100, destination=page_climb_act_ap100)
page_climb_act_ap100.link(button=G.I_BACK_Y, destination=page_climb_act)
# # 爬塔活动boss战界面
